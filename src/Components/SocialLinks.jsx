  ...
  return (
    <div>
        {/* Desktop Social Icons */}
              <section className="w-full h-[150px] flex items-center justify-center gap-10 md:hidden">
                  ...
                  <a href="#github"><FaGithub size={35} className="text-blue-600 cursor-pointer hover:text-blue-400 hover:border-b-2" /></a>
              </section>
    </div>
  )
}
