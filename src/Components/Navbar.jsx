    ...
    <div className="w-full h-[100px] flex justify-center items-center text-black sticky top-0 z-50">
      ...
      >
        ...
        <ul className="mt-5 space-y-6 text-black text-xl pl-6">
          ...
          <li><Link to="/contact" onClick={() => setIsOpen(false)}>Notes</Link></li>
          <li><Link to="/blogs" onClick={() => setIsOpen(false)}>Contact</Link></li>
          <li><Link to="/blogs" onClick={() => setIsOpen(false)}>Projects</Link></li>
        </ul>
      </div>
    </div>
  );
